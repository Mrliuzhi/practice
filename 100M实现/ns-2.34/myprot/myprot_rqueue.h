#ifndef __myprot_rqueue_h__
#define __myprot_rqueue_h_
 ...
 */
#define MYPROT_RTQ_MAX_LEN     64      // packets

/*
 *  The maximum period of time that a routing protocol is allowed to buffer
 *  a packet for.
 */
#define MYPROT_RTQ_TIMEOUT     30	// seconds

class myprot_rqueue : public Connector {
 public:
        myprot_rqueue();
