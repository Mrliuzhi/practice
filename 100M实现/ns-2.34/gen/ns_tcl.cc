...
\"\n\
checkout_executable TCLSH \"/usr/ns-allinone-2.34/bin/tclsh8.4\" tclsh \"\\\n\
When configured, ns found the right version of tclsh in\\\n\
/usr/ns-allinone-2.34/bin/tclsh8.4\n\
but it doesn't seem to be there anymore, so\\\n\
...
Mac/802_11 set basicRate_ 100Mb  ;# set this to 0 if want to use bandwidth_ for \n\
Mac/802_11 set dataRate_ 100Mb   ;# both control and data pkts\n\
}\n\
if [TclObject is-class Mac/MYMac] {\n\
Mac/MYMac set delay_ 64us\n\
Mac/MYMac set ifs_ 16us\n\
Mac/MYMac set slotTime_ 16us\n\
Mac/MYMac set cwmin_ 16\n\
Mac/MYMac set cwmax_ 1024\n\
Mac/MYMac set rtxLimit_ 16\n\
Mac/MYMac set bssId_ -1\n\
Mac/MYMac set sifs_ 8us\n\
Mac/MYMac set pifs_ 12us\n\
Mac/MYMac set difs_ 16us\n\
Mac/MYMac set rtxAckLimit_ 1\n\
Mac/MYMac set rtxRtsLimit_ 3\n\
Mac/MYMac set basicRate_ 1Mb  ;# set this to 0 if want to use bandwidth_ for \n\
Mac/MYMac set dataRate_ 1Mb   ;# both control and data pkts\n\
}\n\
...
\n\
\n\
Mac/MYMac set CWMin_         31\n\
Mac/MYMac set CWMax_         1023\n\
Mac/MYMac set SlotTime_      0.000020        ;# 20us\n\
Mac/MYMac set SIFS_          0.000010        ;# 10us\n\
Mac/MYMac set PreambleLength_        144             ;# 144 bit\n\
Mac/MYMac set PLCPHeaderLength_      48              ;# 48 bits\n\
Mac/MYMac set PLCPDataRate_  1.0e6           ;# 1Mbps\n\
Mac/MYMac set RTSThreshold_  0               ;# bytes\n\
Mac/MYMac set ShortRetryLimit_       7               ;# retransmittions\n\
Mac/MYMac set LongRetryLimit_        4               ;# retransmissions\n\
\n\
Mac/MYMac set bugFix_timer_ true;         # fix for when RTS/CTS not used\n\
\n\
Mac/MYMac set BeaconInterval_	       0.1		;# 100ms	\n\
Mac/MYMac set ScanType_	PASSIVE\n\
Mac/MYMac set ProbeDelay_	0.0001		;# 0.1 ms\n\
Mac/MYMac set MaxChannelTime_ 0.011		;# 11 ms\n\
Mac/MYMac set MinChannelTime_ 0.005		; # 5 ms\n\
Mac/MYMac set ChannelTime_ 0.12		;# 120 ms\n\
\n\
\n\
\n\
Mac/802_11 set CWMin_         31\n\
Mac/802_11 set CWMax_         1023\n\
Mac/802_11 set SlotTime_      0.00000020        ;# 20us\n\
Mac/802_11 set SIFS_          0.00000010        ;# 10us\n\
Mac/802_11 set PreambleLength_        144             ;# 144 bit\n\
Mac/802_11 set PLCPHeaderLength_      48              ;# 48 bits\n\
Mac/802_11 set PLCPDataRate_  1.0e8           ;# 1Mbps\n\
...
Mac/802_11Ext set LongRetryLimit_   4802\n\
\n\
...
Phy/WirelessPhy set CSThresh_ 9.74527e-13\n\
Phy/WirelessPhy set RXThresh_ 2.28289e-11\n\
\n\
Phy/WirelessPhy set bandwidth_ 1e8\n\
...
MYPROT {\n\
set ragent [$self create-myprot-agent $node]\n\
}\n\
AOMDV {\n\
...
Simulator instproc create-myprot-agent { node } {\n\
set ragent [new Agent/MYPROT [$node node-addr]]\n\
$self at 0.0 \"$ragent start\"     ;# start BEACON/HELLO Messages\n\
$node set ragent_ $ragent\n\
return $ragent\n\
}\n\
